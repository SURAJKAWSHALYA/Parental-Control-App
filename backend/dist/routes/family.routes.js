...
const requireRecentAuth_middleware_1 = require("../middleware/requireRecentAuth.middleware");
...
router.delete('/delete-data', (0, auth_middleware_1.requirePermission)('FULL_CONTROL'), requireRecentAuth_middleware_1.requireRecentAuth, family_controller_1.deleteFamilyData);
